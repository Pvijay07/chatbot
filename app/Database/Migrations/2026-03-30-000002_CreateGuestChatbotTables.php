...
class CreateGuestChatbotTables extends Migration
{
    public function up()
    {
        ...
        if (!$this->db->tableExists('insurance_plans')) {
            $this->forge->addField([
                'id' => [
                    'type'           => 'BIGINT',
                    'unsigned'       => true,
        ...
        if (!$this->db->tableExists('insurance_documents')) {
            $this->forge->addField([
                'id' => [
                    'type'           => 'BIGINT',
                    'unsigned'       => true,
        ...
        if (!$this->db->tableExists('insurance_document_chunks')) {
            $this->forge->addField([
                'id' => [
                    'type'           => 'BIGINT',
                    'unsigned'       => true,
    ...
    {
        // Intentionally left blank to avoid dropping live chatbot data.
    }
}
